...
> Supporting reference `s5.03` in [the bank](2.sd.md#supporting-references); not a ranked question. LLD staple. Sibling of s1.03's lock discipline and s3.05's lease thinking; HikariCP is the reference implementation.
