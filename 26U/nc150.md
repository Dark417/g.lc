...
### Arrays & Hashing
[E] [1. Two Sum](https://leetcode.cn/problems/two-sum/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [217. Contains Duplicate](https://leetcode.cn/problems/contains-duplicate/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [242. Valid Anagram](https://leetcode.cn/problems/valid-anagram/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [49. Group Anagrams](https://leetcode.cn/problems/group-anagrams/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [347. Top K Frequent Elements](https://leetcode.cn/problems/top-k-frequent-elements/)
  Key interview pattern for this problem.
  `neetcode150`
...
[M] [36. Valid Sudoku](https://leetcode.cn/problems/valid-sudoku/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [128. Longest Consecutive Sequence](https://leetcode.cn/problems/longest-consecutive-sequence/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [271. Encode and Decode Strings](https://leetcode.cn/problems/encode-and-decode-strings/)
  Key interview pattern for this problem.
  `neetcode150`

### Two Pointers
[E] [125. Valid Palindrome](https://leetcode.cn/problems/valid-palindrome/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [167. Two Sum II - Input Array Is Sorted](https://leetcode.cn/problems/two-sum-ii-input-array-is-sorted/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [15. 3Sum](https://leetcode.cn/problems/3sum/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [11. Container With Most Water](https://leetcode.cn/problems/container-with-most-water/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [42. Trapping Rain Water](https://leetcode.cn/problems/trapping-rain-water/)
  Key interview pattern for this problem.
  `neetcode150`

### Sliding Window
[E] [121. Best Time to Buy And Sell Stock](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [3. Longest Substring Without Repeating Characters](https://leetcode.cn/problems/longest-substring-without-repeating-characters/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [424. Longest Repeating Character Replacement](https://leetcode.cn/problems/longest-repeating-character-replacement/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [567. Permutation In String](https://leetcode.cn/problems/permutation-in-string/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [76. Minimum Window Substring](https://leetcode.cn/problems/minimum-window-substring/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [239. Sliding Window Maximum](https://leetcode.cn/problems/sliding-window-maximum/)
  Key interview pattern for this problem.
  `neetcode150`

### Stack
[E] [20. Valid Parentheses](https://leetcode.cn/problems/valid-parentheses/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [155. Min Stack](https://leetcode.cn/problems/min-stack/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [150. Evaluate Reverse Polish Notation](https://leetcode.cn/problems/evaluate-reverse-polish-notation/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [22. Generate Parentheses](https://leetcode.cn/problems/generate-parentheses/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [739. Daily Temperatures](https://leetcode.cn/problems/daily-temperatures/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [853. Car Fleet](https://leetcode.cn/problems/car-fleet/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [84. Largest Rectangle in Histogram](https://leetcode.cn/problems/largest-rectangle-in-histogram/)
  Key interview pattern for this problem.
  `neetcode150`

### Binary Search
[E] [704. Binary Search](https://leetcode.cn/problems/binary-search/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [74. Search a 2D Matrix](https://leetcode.cn/problems/search-a-2d-matrix/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [875. Koko Eating Bananas](https://leetcode.cn/problems/koko-eating-bananas/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [153. Find Minimum In Rotated Sorted Array](https://leetcode.cn/problems/find-minimum-in-rotated-sorted-array/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [33. Search In Rotated Sorted Array](https://leetcode.cn/problems/search-in-rotated-sorted-array/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [981. Time Based Key-Value Store](https://leetcode.cn/problems/time-based-key-value-store/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [4. Median of Two Sorted Arrays](https://leetcode.cn/problems/median-of-two-sorted-arrays/)
  Key interview pattern for this problem.
  `neetcode150`

### Linked List
[E] [206. Reverse Linked List](https://leetcode.cn/problems/reverse-linked-list/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [21. Merge Two Sorted Lists](https://leetcode.cn/problems/merge-two-sorted-lists/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [141. Linked List Cycle](https://leetcode.cn/problems/linked-list-cycle/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [143. Reorder List](https://leetcode.cn/problems/reorder-list/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [19. Remove Nth Node From End of List](https://leetcode.cn/problems/remove-nth-node-from-end-of-list/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [138. Copy List with Random Pointer](https://leetcode.cn/problems/copy-list-with-random-pointer/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [2. Add Two Numbers](https://leetcode.cn/problems/add-two-numbers/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [287. Find the Duplicate Number](https://leetcode.cn/problems/find-the-duplicate-number/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [146. LRU Cache](https://leetcode.cn/problems/lru-cache/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [23. Merge K Sorted Lists](https://leetcode.cn/problems/merge-k-sorted-lists/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [25. Reverse Nodes in k-Group](https://leetcode.cn/problems/reverse-nodes-in-k-group/)
  Key interview pattern for this problem.
  `neetcode150`

### Trees
[E] [226. Invert Binary Tree](https://leetcode.cn/problems/invert-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [104. Maximum Depth of Binary Tree](https://leetcode.cn/problems/maximum-depth-of-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [543. Diameter of Binary Tree](https://leetcode.cn/problems/diameter-of-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [110. Balanced Binary Tree](https://leetcode.cn/problems/balanced-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [100. Same Tree](https://leetcode.cn/problems/same-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [572. Subtree of Another Tree](https://leetcode.cn/problems/subtree-of-another-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [235. Lowest Common Ancestor of a Binary Search Tree](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-search-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [102. Binary Tree Level Order Traversal](https://leetcode.cn/problems/binary-tree-level-order-traversal/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [199. Binary Tree Right Side View](https://leetcode.cn/problems/binary-tree-right-side-view/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [1448. Count Good Nodes In Binary Tree](https://leetcode.cn/problems/count-good-nodes-in-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [98. Validate Binary Search Tree](https://leetcode.cn/problems/validate-binary-search-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [230. Kth Smallest Element In a Bst](https://leetcode.cn/problems/kth-smallest-element-in-a-bst/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [105. Construct Binary Tree From Preorder And Inorder Traversal](https://leetcode.cn/problems/construct-binary-tree-from-preorder-and-inorder-traversal/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [124. Binary Tree Maximum Path Sum](https://leetcode.cn/problems/binary-tree-maximum-path-sum/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [297. Serialize And Deserialize Binary Tree](https://leetcode.cn/problems/serialize-and-deserialize-binary-tree/)
  Key interview pattern for this problem.
  `neetcode150`

### Tries
[M] [208. Implement Trie Prefix Tree](https://leetcode.cn/problems/implement-trie-prefix-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [211. Design Add And Search Words Data Structure](https://leetcode.cn/problems/design-add-and-search-words-data-structure/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [212. Word Search II](https://leetcode.cn/problems/word-search-ii/)
  Key interview pattern for this problem.
  `neetcode150`

### Heap / Priority Queue
[E] [703. Kth Largest Element in a Stream](https://leetcode.cn/problems/kth-largest-element-in-a-stream/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [1046. Last Stone Weight](https://leetcode.cn/problems/last-stone-weight/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [215. Kth Largest Element in an Array](https://leetcode.cn/problems/kth-largest-element-in-an-array/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [973. K Closest Points to Origin](https://leetcode.cn/problems/k-closest-points-to-origin/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [621. Task Scheduler](https://leetcode.cn/problems/task-scheduler/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [355. Design Twitter](https://leetcode.cn/problems/design-twitter/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [295. Find Median From Data Stream](https://leetcode.cn/problems/find-median-from-data-stream/)
  Key interview pattern for this problem.
  `neetcode150`

### Backtracking
[M] [78. Subsets](https://leetcode.cn/problems/subsets/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [39. Combination Sum](https://leetcode.cn/problems/combination-sum/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [46. Permutations](https://leetcode.cn/problems/permutations/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [90. Subsets II](https://leetcode.cn/problems/subsets-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [40. Combination Sum II](https://leetcode.cn/problems/combination-sum-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [79. Word Search](https://leetcode.cn/problems/word-search/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [131. Palindrome Partitioning](https://leetcode.cn/problems/palindrome-partitioning/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [17. Letter Combinations of a Phone Number](https://leetcode.cn/problems/letter-combinations-of-a-phone-number/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [51. N-Queens](https://leetcode.cn/problems/n-queens/)
  Key interview pattern for this problem.
  `neetcode150`

### Graphs
[M] [200. Number of Islands](https://leetcode.cn/problems/number-of-islands/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [695. Max Area of Island](https://leetcode.cn/problems/max-area-of-island/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [133. Clone Graph](https://leetcode.cn/problems/clone-graph/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [286. Walls and Gates](https://leetcode.cn/problems/walls-and-gates/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [994. Rotting Oranges](https://leetcode.cn/problems/rotting-oranges/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [417. Pacific Atlantic Water Flow](https://leetcode.cn/problems/pacific-atlantic-water-flow/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [130. Surrounded Regions](https://leetcode.cn/problems/surrounded-regions/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [207. Course Schedule](https://leetcode.cn/problems/course-schedule/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [210. Course Schedule II](https://leetcode.cn/problems/course-schedule-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [684. Redundant Connection](https://leetcode.cn/problems/redundant-connection/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [261. Graph Valid Tree](https://leetcode.cn/problems/graph-valid-tree/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [323. Number of Connected Components In An Undirected Graph](https://leetcode.cn/problems/number-of-connected-components-in-an-undirected-graph/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [127. Word Ladder](https://leetcode.cn/problems/word-ladder/)
  Key interview pattern for this problem.
  `neetcode150`

### Advanced Graphs
[H] [332. Reconstruct Itinerary](https://leetcode.cn/problems/reconstruct-itinerary/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [1584. Min Cost to Connect All Points](https://leetcode.cn/problems/min-cost-to-connect-all-points/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [743. Network Delay Time](https://leetcode.cn/problems/network-delay-time/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [787. Cheapest Flights Within K Stops](https://leetcode.cn/problems/cheapest-flights-within-k-stops/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [778. Swim in Rising Water](https://leetcode.cn/problems/swim-in-rising-water/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [269. Alien Dictionary](https://leetcode.cn/problems/alien-dictionary/)
  Key interview pattern for this problem.
  `neetcode150`

### 1-D Dynamic Programming
[E] [70. Climbing Stairs](https://leetcode.cn/problems/climbing-stairs/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [746. Min Cost Climbing Stairs](https://leetcode.cn/problems/min-cost-climbing-stairs/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [198. House Robber](https://leetcode.cn/problems/house-robber/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [213. House Robber II](https://leetcode.cn/problems/house-robber-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [5. Longest Palindromic Substring](https://leetcode.cn/problems/longest-palindromic-substring/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [647. Palindromic Substrings](https://leetcode.cn/problems/palindromic-substrings/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [91. Decode Ways](https://leetcode.cn/problems/decode-ways/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [322. Coin Change](https://leetcode.cn/problems/coin-change/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [152. Maximum Product Subarray](https://leetcode.cn/problems/maximum-product-subarray/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [139. Word Break](https://leetcode.cn/problems/word-break/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [300. Longest Increasing Subsequence](https://leetcode.cn/problems/longest-increasing-subsequence/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [416. Partition Equal Subset Sum](https://leetcode.cn/problems/partition-equal-subset-sum/)
  Key interview pattern for this problem.
  `neetcode150`

### 2-D Dynamic Programming
[M] [62. Unique Paths](https://leetcode.cn/problems/unique-paths/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [1143. Longest Common Subsequence](https://leetcode.cn/problems/longest-common-subsequence/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [309. Best Time to Buy and Sell Stock with Cooldown](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-with-cooldown/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [518. Coin Change II](https://leetcode.cn/problems/coin-change-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [494. Target Sum](https://leetcode.cn/problems/target-sum/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [97. Interleaving String](https://leetcode.cn/problems/interleaving-string/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [120. Triangle](https://leetcode.cn/problems/triangle/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [115. Distinct Subsequences](https://leetcode.cn/problems/distinct-subsequences/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [72. Edit Distance](https://leetcode.cn/problems/edit-distance/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [329. Longest Increasing Path in a Matrix](https://leetcode.cn/problems/longest-increasing-path-in-a-matrix/)
  Key interview pattern for this problem.
  `neetcode150`

[H] [312. Burst Balloons](https://leetcode.cn/problems/burst-balloons/)
  Key interview pattern for this problem.
  `neetcode150`

### Greedy
[M] [53. Maximum Subarray](https://leetcode.cn/problems/maximum-subarray/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [55. Jump Game](https://leetcode.cn/problems/jump-game/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [45. Jump Game II](https://leetcode.cn/problems/jump-game-ii/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [134. Gas Station](https://leetcode.cn/problems/gas-station/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [846. Hand of Straights](https://leetcode.cn/problems/hand-of-straights/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [1899. Merge Triplets to Form Target Triplet](https://leetcode.cn/problems/merge-triplets-to-form-target-triplet/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [763. Partition Labels](https://leetcode.cn/problems/partition-labels/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [678. Valid Parenthesis String](https://leetcode.cn/problems/valid-parenthesis-string/)
  Key interview pattern for this problem.
  `neetcode150`

### Intervals
[M] [57. Insert Interval](https://leetcode.cn/problems/insert-interval/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [56. Merge Intervals](https://leetcode.cn/problems/merge-intervals/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [435. Non Overlapping Intervals](https://leetcode.cn/problems/non-overlapping-intervals/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [252. Meeting Rooms](https://leetcode.cn/problems/meeting-rooms/)
  Key interview pattern for this problem.
  `neetcode150`
...
[H] [1851. Minimum Interval to Include Each Query](https://leetcode.cn/problems/minimum-interval-to-include-each-query/)
  Key interview pattern for this problem.
  `neetcode150`

### Math & Geometry
[M] [48. Rotate Image](https://leetcode.cn/problems/rotate-image/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [54. Spiral Matrix](https://leetcode.cn/problems/spiral-matrix/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [73. Set Matrix Zeroes](https://leetcode.cn/problems/set-matrix-zeroes/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [202. Happy Number](https://leetcode.cn/problems/happy-number/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [66. Plus One](https://leetcode.cn/problems/plus-one/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [50. Pow(x, n)](https://leetcode.cn/problems/powx-n/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [43. Multiply Strings](https://leetcode.cn/problems/multiply-strings/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [2013. Detect Squares](https://leetcode.cn/problems/detect-squares/)
  Key interview pattern for this problem.
  `neetcode150`

### Bit Manipulation
[E] [136. Single Number](https://leetcode.cn/problems/single-number/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [191. Number of 1 Bits](https://leetcode.cn/problems/number-of-1-bits/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [338. Counting Bits](https://leetcode.cn/problems/counting-bits/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [190. Reverse Bits](https://leetcode.cn/problems/reverse-bits/)
  Key interview pattern for this problem.
  `neetcode150`

[E] [268. Missing Number](https://leetcode.cn/problems/missing-number/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [371. Sum of Two Integers](https://leetcode.cn/problems/sum-of-two-integers/)
  Key interview pattern for this problem.
  `neetcode150`

[M] [7. Reverse Integer](https://leetcode.cn/problems/reverse-integer/)
  Key interview pattern for this problem.
  `neetcode150`
