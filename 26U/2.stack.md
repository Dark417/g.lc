...
- [E] [1047. Remove All Adjacent Duplicates In String](#lc-1047)  
  Remove adjacent equal pairs until no duplicate pair remains.  
  `Stack` `String`

- [E] [844. Backspace String Compare](#lc-0844)  
  Apply each string's backspaces and compare the resulting text.  
...
#### 1047. [Remove All Adjacent Duplicates In String](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/) [E]

Remove adjacent equal character pairs until the string is stable.  
`Stack` `String`

##### Approach 1: Cancellation Stack

Use the stack top as the current surviving neighbor; matching characters cancel, while different characters are retained.
...
Build the text that remains after applying backspaces, then compare both results.  
`Stack` `String` `Simulation`

##### Approach 1: Simulate Each String With a Stack

Push ordinary characters and pop the most recent surviving character whenever a backspace appears.
