...
- [M] [238. Product of Array Except Self](#lc-0238)  
  — Product of all elements except current, without division.  

- [M] [271. Encode and Decode Strings](#lc-0271)  
  — Serialize and deserialize a list of strings safely.  
...
- [M] [424. Longest Repeating Character Replacement](#lc-0424)  
  — Longest substring after up to k replacements.  

- [H] [76. Minimum Window Substring](#lc-0076)  
  — Smallest window covering all characters of a pattern.  

### Stack

- [E] [20. Valid Parentheses](#lc-0020)  
  — Check matching and properly nested brackets.  
...
- [H] [23. Merge K Sorted Lists](#lc-0023)  
  — Merge k sorted lists into one efficiently.  
...
- [E] [226. Invert Binary Tree](#lc-0226)  
  — Swap left/right children for every node.  
...
- [M] [235. Lowest Common Ancestor of a Binary Search Tree](#lc-0235)  
  — LCA using BST properties.  

- [H] [124. Binary Tree Maximum Path Sum](#lc-0124)  
  — Max path sum anywhere in the tree.  
...
- [M] [39. Combination Sum](#lc-0039)  
  — Find combinations summing to target (reuse allowed).  

- [M] [79. Word Search](#lc-0079)  
  — Backtracking to find a single word in a grid.  
...
- [M] [62. Unique Paths](#lc-0062)  
  — Count grid paths with only right/down moves.  
...
- [M] [55. Jump Game](#lc-0055)  
  — Greedy farthest-reachability check.  

### Intervals

- [E] [252. Meeting Rooms](#lc-0252)  
  — Can attend all meetings without overlap?  
...
- [M] [435. Non Overlapping Intervals](#lc-0435)  
  — Minimum removals to avoid overlaps.  
...
- [M] [73. Set Matrix Zeroes](#lc-0073)  
  — Zero rows/cols containing a zero (in-place).  

### Bit Manipulation

- [E] [190. Reverse Bits](#lc-0190)  
  — Reverse bits in a fixed-width integer.  
...
- [E] [338. Counting Bits](#lc-0338)  
  — Count bits for all numbers up to n.  
