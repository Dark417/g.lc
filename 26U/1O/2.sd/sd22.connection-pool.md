# sd22. Thread-Safe DB Connection Pool (LLD)

> Bank #22 (◇ aggregator, 🎯 LLD staple; promoted with the distributed set). Sibling of sd03's lock discipline and sd18's lease thinking; HikariCP is the reference implementation.
